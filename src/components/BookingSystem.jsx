...
export default function BookingSystem() {
  ...
  return (
    <section id="reservations" className="bg-cream-50 py-16 px-4 sm:px-6 lg:px-8 border-y border-espresso/5">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="font-serif text-3xl sm:text-4xl font-bold text-espresso mt-3 mb-4">
          Reserve Your Spot
        </h2>
        <p className="font-sans text-xs sm:text-sm text-charcoal/80 max-w-xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left mb-10">
          {bookingOptions.map((opt, idx) => (
            <div
              key={idx}
              className="bg-white rounded-2xl p-6 border border-espresso/5 shadow-sm hover:shadow-md transition-all duration-300"
            >
              ...
              <h3 className="font-serif text-base sm:text-lg font-bold text-espresso mb-1.5">
                {opt.title}
              </h3>
        ...
        <div className="glassmorphism rounded-3xl p-6 sm:p-8 border border-espresso/5 max-w-xl mx-auto shadow-sm">
          <h4 className="font-serif text-base sm:text-lg font-bold text-espresso mb-2">
            Instant Inquiry via WhatsApp
          </h4>
          <p className="font-sans text-xs text-charcoal/70 mb-5 leading-relaxed">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-espresso hover:bg-espresso-100 text-cream-50 text-xs font-bold uppercase tracking-widest rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-md hover:shadow-lg cursor-pointer"
          >
